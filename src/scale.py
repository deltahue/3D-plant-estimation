...
class April:
	def __init__(self):
		images = col.read_images_binary("bigPlantDataSetWithAprilTag_lowres/sparse/0/images.bin");
		...
		for i in range(len(images)):
			...
			image = cv2.imread("../big/"+imageInteresting.name)
		...
		Cid3 = closest3DId_C
		Did3 = closest3DId_D
		self.points3d = col.read_points3d_binary("bigPlantDataSetWithAprilTag_lowres/sparse/0/points3D.bin");

		self.a = points3d[Aid3].xyz
		self.b = points3d[Bid3].xyz
		self.c = points3d[Cid3].xyz
		self.d = points3d[Did3].xyz
